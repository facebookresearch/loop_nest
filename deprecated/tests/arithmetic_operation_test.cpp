...
int main()
{
    ...
    // if (0)
    {
        ...
        auto gen_loop_nest = [&]() {
            return facebook::sysml::aot::loop_nest_code_generator<DABUN_ISA>(
                       ...
                       {{"AcBr", BcCc}, {"BcCc", 1}},
                       facebook::sysml::aot::non_fused_ma, 1024)
                .get_unique();
        };
        ...
        auto gen_loop_nest = [&]() {
            return facebook::sysml::aot::loop_nest_code_generator<DABUN_ISA>(
                       ...
                       {{"g_in", COUT * KS * KS * CIN * GOUT},
                        ...
                        {"k_w", COUT},
                        {"c_out", 1}},
                       facebook::sysml::aot::non_fused_ma)
                .get_shared();
        };
    ...
    // a single element and 0 strides.
    {
        ...
        auto gen_loop_nest = [&]() {
            return facebook::sysml::aot::loop_nest_code_generator<DABUN_ISA>(
                       ...
                       {{"ArCr", 0}, {"AcBr", 0}},
                       // B's strides for each variable
                       {{"AcBr", 1}, {"BcCc", AcBr}}, facebook::sysml::aot::fma,
                       512, nullptr, {},
    ...
    // if (0)
    {
        ...
        auto gen_loop_nest = [&]() {
            return facebook::sysml::aot::loop_nest_code_generator<DABUN_ISA>(
                       ...
                       {{"k", 1}},
                       // B's strides for each variable
                       {{"k", c}, {"c", 1}}, facebook::sysml::aot::fma)
                .get_shared();
        };
    ...
    // Using non-fused multiply accumulate
    {
        std::cout << "Benchmark: 1 (non-fused-ma)" << std::endl;
    ...
    // if (0)
    {
        std::cout << "Benchmark: 2 (non-fused-ma)" << std::endl;
    ...
    {
        std::cout << "Benchmark: 1 (alternative innermost ops,  multiply max)"
                  << std::endl;
        ...
        auto gen_loop_nest = [&]() {
            return facebook::sysml::aot::loop_nest_code_generator<DABUN_ISA>(
                       ...
                       // B's strides for each variable
                       {{"AcBr", BcCc}, {"BcCc", 1}},
                       facebook::sysml::aot::multiply_max, 1024)
                .get_unique();
        };
        ...
        baseline_MM_op_pair(
            ArCr, AcBr, BcCc, AcBr, 1, BcCc, 1, ArCr, 1, A.data(), B.data(),
            CN.data(), 0, -std::numeric_limits<float>::infinity(),
            [](float a, float b) { return std::max<float>(a, b); },
    ...
    // if (0)
    {
        std::cout << "Benchmark: 2 (alternative innermost ops, multiply max)"
                  << std::endl;
        ...
        auto gen_loop_nest = [&]() {
            return facebook::sysml::aot::loop_nest_code_generator<DABUN_ISA>(
                       ...
                       {{"g_in", COUT * KS * KS * CIN * GOUT},
                        ...
                        {"k_w", COUT},
                        {"c_out", 1}},
                       facebook::sysml::aot::multiply_max)
                .get_shared();
        };
        ...
        baseline_Conv_NCHW8c_multiplies_max(GOUT, COUT, GIN, CIN, OS, OS, KS,
                                            KS, A.data(), B.data(), CN.data());
    ...
    {
        std::cout << "Benchmark: 1 (alternative innermost ops, multiply min)"
                  << std::endl;
        ...
        auto gen_loop_nest = [&]() {
            return facebook::sysml::aot::loop_nest_code_generator<DABUN_ISA>(
                       ...
                       // B's strides for each variable
                       {{"AcBr", BcCc}, {"BcCc", 1}},
                       facebook::sysml::aot::multiply_min, 1024)
                .get_unique();
        };
        ...
        baseline_MM_op_pair(
            ArCr, AcBr, BcCc, AcBr, 1, BcCc, 1, ArCr, 1, A.data(), B.data(),
            CN.data(), 0, std::numeric_limits<float>::infinity(),
            [](float a, float b) { return std::min<float>(a, b); },
            std::multiplies<float>());
    ...
    {
        std::cout << "Benchmark: 1 (alternative innermost ops, plus max)"
                  << std::endl;
        ...
        auto gen_loop_nest = [&]() {
            return facebook::sysml::aot::loop_nest_code_generator<DABUN_ISA>(
                       ...
                       // B's strides for each variable
                       {{"AcBr", BcCc}, {"BcCc", 1}},
                       facebook::sysml::aot::plus_max, 1024)
                .get_unique();
        };
