...
AVX2 ptr[reg_base + off]
 ...
 | off                       | bytes                                         |
 |---------------------------+-----------------------------------------------|
 | 0                         | 7  + 1  when reg_base in {rsp, rbp, r12, r13} |
 | [-0x1fc0, 0x2000] by 0x40 | 8  + 1  when reg_base in {rsp, r12}           |
 | rest                      | 11 + 1  when reg_base in {rsp, r12}           |
 |---------------------------+-----------------------------------------------|
 ...
 |------------------------+-----------------------------------------------|
 | 0                      | 7  + 1  when reg_base in {rsp, rbp, r12, r13} |
 | [-0x1fc, 0x200] by 0x4 | 8  + 1  when reg_base in {rsp, r12}           |
 | rest                   | 11 + 1  when reg_base in {rsp, r12}           |
 |------------------------+-----------------------------------------------|
 ...
 | off                       |                              bytes |
 |---------------------------+------------------------------------|
 | 0                         | 8 + 1  when reg_base in {rbp, r13} |
