...
#ifndef DABUN_VEX
#    ifdef DABUN_ARITHMETIC
#        undef DABUN_ARITHMETIC
#    endif
#
#    if defined(SYSML_ARCH_AMD64)
#        define DABUN_VEX extension::avx2
#        define DABUN_ARITHMETIC dabun::float
#    elif defined(SYSML_ARCH_ARM64)
#        define DABUN_VEX extension::aarch64
#        define DABUN_ARITHMETIC dabun::float
#    else
#        error "Not supported"
#    endif
