...
#ifndef OPTIM_LEVEL
#define OPTIM_LEVEL OptimizationConfiguration(true, true, true)
#endif

#ifndef POST_OP
#define POST_OP nullptr
#endif
...
int main() {
  ...
  using facebook::sysml::aot::OptimizationConfiguration;

  {
    ...
    auto gen_loop_nest = [&]() {
      return facebook::sysml::aot::FMA_loop_nest_jitter<CT_ISA>(
                 ...
                 {{"AcBr", BcCc}, {"BcCc", 1}}, facebook::sysml::aot::fma, 1024,
                 nullptr, {}, POST_OP, {}, OPTIM_LEVEL)
          .get_unique();
    };
  ...
  // sum) C(r) = A(r, k) * B(k) if (0)
  {
    ...
    auto gen_loop_nest = [&]() {
      return facebook::sysml::aot::FMA_loop_nest_jitter<CT_ISA>(
                 ...
                 {{"r", k * 2}, {"k", 2}},
                 // B's strides for each variable
                 {{"k", 2}}, facebook::sysml::aot::fma, std::nullopt, nullptr,
                 {}, POST_OP, {}, OPTIM_LEVEL)
          .get_shared();
    };
  ...
  // C(c) = A(k) * B(k, c)
  {
    ...
    auto gen_loop_nest = [&]() {
      return facebook::sysml::aot::FMA_loop_nest_jitter<CT_ISA>(
                 ...
                 {{"k", 1}},
                 // B's strides for each variable
                 {{"k", c}, {"c", 1}}, facebook::sysml::aot::fma, std::nullopt,
                 nullptr, {}, POST_OP, {}, OPTIM_LEVEL)
          .get_shared();
    };
    ...
    auto gen_loop_nest = [&]() {
      return facebook::sysml::aot::FMA_loop_nest_jitter<CT_ISA>(
                 ...
                 {{"g_in", COUT * KS * KS * CIN * GOUT},
                  ...
                  {"k_w", COUT},
                  {"c_out", 1}},
                 facebook::sysml::aot::fma, std::nullopt, nullptr, {}, POST_OP,
                 {}, OPTIM_LEVEL)
          .get_shared();
    };
  ...
  //              B(x_k, y_k, z_k)
  {
    ...
    auto gen_loop_nest = [&]() {
      return facebook::sysml::aot::FMA_loop_nest_jitter<CT_ISA>(
                 ...
                 // B's strides for each variable
                 {{"KX", KY * KZ}, {"KY", KZ}, {"KZ", 1}},
                 facebook::sysml::aot::fma, 1024, nullptr, {}, POST_OP, {},
                 OPTIM_LEVEL)
          .get_shared();
    };
